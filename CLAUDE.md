...
- Integration auto-discovers _.jpg,_.png files
...
docker run -d --name ha-dev -p 8123:8123 \
  ...
  -v ~/dev/ha-chameleon/custom_components:/config/custom_components \
...
rsync -avz --delete \
  ~/projects/ha-chameleon/custom_components/chameleon/ \
